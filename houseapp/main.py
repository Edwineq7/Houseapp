from tkinter import PhotoImage, Tk , Label, Canvas, messagebox
from PIL import Image, ImageTk
import time
flag1, flag2, flag3, flag4 = False, False, False, False

def actualizarHora():
    labelHora.config(text="Hora: " + time.strftime("%H:%M:%S") 
...
def apagarEncender(event, foco = None):
    ...
    if foco == Canvas1:
        if flag1 == False:
           foco1 = ImageTk.PhotoImage(Image.open("img/focoOn.jpeg").resize((32,32)))
        ...
        if flag2 == False:
           foco2 = ImageTk.PhotoImage(Image.open("img/focoOn.jpeg").resize((32,32)))
        ...
        if flag3 == False:
           foco3 = ImageTk.PhotoImage(Image.open("img/focoOn.jpeg").resize((32,32)))
        ...
        if flag4 == False:
           foco4 = ImageTk.PhotoImage(Image.open("img/focoOn.jpeg").resize((32,32)))
...
ventana.title("GUI Activación de LED's")
ventana.iconbitmap("img/Led.ico")
titulo = Label(ventana, text = "Activación de LED's", font = ("Arial", 20, "bold"))
titulo.pack()
try:
    imagen = Image.open("img/planocasa.jpeg")
    fondo = ImageTk.PhotoImage(imagen)
    focoOff1 = Image.open("img/focoOff.jpeg").resize((32,32))
    focoOff2 = Image.open("img/focoOff.jpeg").resize((32,32))
    focoOff3 = Image.open("img/focoOff.jpeg").resize((32,32))
    focoOff4 = Image.open("img/focoOff.jpeg").resize((32,32))
    foco1 = ImageTk.PhotoImage(focoOff1)
    foco2 = ImageTk.PhotoImage(focoOff2)
    foco3 = ImageTk.PhotoImage(focoOff3)
    foco4 = ImageTk.PhotoImage(focoOff4)
...
labelNombre = Label(ventana, text = "By: Edwin Quintero", font = ("Arial", 12))
